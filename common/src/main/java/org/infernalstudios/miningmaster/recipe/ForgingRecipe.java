...
//
//    public ForgingRecipe(Ingredient catalyst, NonNullList<Ingredient> recipeGems, NonNullList<Pair<Enchantment,Integer>> enchantments, ItemStack result) {
...
//    }
//
//    public boolean matches(ForgingRecipeInput recipeInput, Level worldIn) {
...
//        ItemStack itemstack = this.result.copy();
//        CompoundTag compoundnbt = recipeInput.getItem(0).getTag();
//        if (compoundnbt != null) {
