...
public class MMRecipes {
    ...
    public static final RegistrySupplier<RecipeSerializer<GemForgingRecipe>> GEM_FORGING_RECIPE = RECIPE_SERIALIZERS.register(
            "forging_recipe",
            GemForgingRecipe.GemForgingRecipeSerializer::new
    );
