...
public class GemAxeItem extends AxeItem {
    ...
    @SafeVarargs
    public GemAxeItem(Tier tier, Ingredient repairItems, int attackDamage, float attackSpeed, Properties properties, Pair<ResourceKey<Enchantment>, Integer>... enchantments) {
        super(tier, properties.attributes(AxeItem.createAttributes(
                tier,
                attackDamage,
                attackSpeed
        )));
