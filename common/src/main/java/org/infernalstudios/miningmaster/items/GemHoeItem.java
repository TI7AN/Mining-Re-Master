...
public class GemHoeItem extends HoeItem {
    ...
    @SafeVarargs
    public GemHoeItem(Tier tier, Ingredient repairItems, int attackDamage, float attackSpeed, Properties properties, Pair<ResourceKey<Enchantment>, Integer>... enchantments) {
        super(tier, properties.attributes(HoeItem.createAttributes(
                tier,
                attackDamage,
                attackSpeed
        )));
