...
public class GemShovelItem extends ShovelItem {
    ...
    @SafeVarargs
    public GemShovelItem(Tier tier, Ingredient repairItems, int attackDamage, float attackSpeed, Properties properties, Pair<ResourceKey<Enchantment>, Integer>... enchantments) {
        super(tier, properties.attributes(ShovelItem.createAttributes(
                tier,
                attackDamage,
                attackSpeed
        )));
