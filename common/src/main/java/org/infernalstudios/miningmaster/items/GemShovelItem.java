...
//
//    @SafeVarargs
//    public GemShovelItem(Tier tier, Ingredient repairItems, float attackDamageIn, float attackSpeedIn, Properties builder, Pair<Supplier<Enchantment>, Integer>... enchantments) {
