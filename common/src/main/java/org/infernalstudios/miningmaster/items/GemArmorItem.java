...
public class GemArmorItem extends ArmorItem {
    ...
    @SafeVarargs
    public GemArmorItem(Holder<ArmorMaterial> material, Ingredient repairItems, Type slot, Properties builderIn, Pair<ResourceKey<Enchantment>, Integer>... enchantments) {
