...
//@OnlyIn(Dist.CLIENT)
public class GemForgeScreen extends AbstractContainerScreen<GemForgeMenu> implements RecipeUpdateListener {
    private static final ResourceLocation GUI_TEXTURE =  ResourceLocation.fromNamespaceAndPath(MiningMaster.MOD_ID, "textures/gui/container/gem_forge.png");
//    private static final ResourceLocation BUTTON_TEXTURE = ResourceLocation.fromNamespaceAndPath(MiningMaster.MOD_ID, "textures/gui/recipe_button.png");
...
//    private static final WidgetSprites RECIPE_BUTTON_SPRITES =
//            new WidgetSprites(
//                    BUTTON_TEXTURE, // normal
//                    BUTTON_TEXTURE  // hovered
//            );

    private boolean widthTooNarrowIn;
    public final RecipeBookComponent recipeGui;

    public GemForgeScreen(GemForgeMenu screenContainer, Inventory inv, Component name) {
        super(screenContainer, inv, name);
        MiningMaster.LOGGER.info("GemForgeScreen was created");
        this.recipeGui = new GemForgeRecipeGui();
    }

    public void init() {
        super.init();
        MiningMaster.LOGGER.info("GemForgeScreen was initialized");
