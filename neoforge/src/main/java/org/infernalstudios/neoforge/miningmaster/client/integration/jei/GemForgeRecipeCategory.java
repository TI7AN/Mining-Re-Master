package org.infernalstudios.neoforge.miningmaster.client.integration.jei;
...
public class GemForgeRecipeCategory implements IRecipeCategory<GemForgingRecipe> {
  public static final RecipeType<GemForgingRecipe> RECIPE_TYPE = RecipeType.create(MiningMaster.MOD_ID, "gem_forging", GemForgingRecipe.class);
  private static final String TITLE_TRANSLATION_KEY = MiningMaster.MOD_ID + ".jei.gem_forging";
  ...
  public GemForgeRecipeCategory(IGuiHelper guiHelper) {
    this.background = guiHelper.createDrawable(ResourceLocation.fromNamespaceAndPath(MiningMaster.MOD_ID, "textures/gui/container/gem_forge.png"), 0, 185, 151, 54);
    this.icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(MMBlocks.GEM_FORGE.get().asItem()));
  }

  @Override
  public RecipeType<GemForgingRecipe> getRecipeType() {
    return RECIPE_TYPE;
  }
